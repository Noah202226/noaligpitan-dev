...
export default function Hero() {
  return (
    <section
      ...
      bg-gradient-to-b from-indigo-50 via-white to-gray-100 
      dark:from-gray-900 dark:via-gray-950 dark:to-black overflow-hidden"
    >
      {/* Background pattern */}
      <div className="absolute inset-0 bg-[url('/grid.svg')] opacity-10 dark:opacity-20 pointer-events-none"></div>
      ...
      >
        <div className="relative w-48 h-48 sm:w-64 sm:h-64 md:w-96 md:h-96">
          <Image
            ...
            alt="Noa"
            fill
            className="rounded-3xl object-cover border-4 border-gray-200 dark:border-indigo-500 shadow-xl"
          />
        </div>
      </motion.div>
    </section>
